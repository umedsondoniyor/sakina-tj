    ...
    <div className="p-6 space-y-8">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="px-4 py-2 bg-brand-turquoise text-white rounded-lg hover:bg-brand-navy transition-colors flex items-center font-semibold"
        >
...
const Section = <T extends { id: string }>({
  ...
  <div className="bg-white rounded-lg shadow border p-6">
    <div className="flex justify-between items-center mb-4">
      ...
      <button
        onClick={onAdd}
        className="flex items-center px-4 py-2 bg-brand-turquoise text-white rounded-lg hover:bg-brand-navy transition-colors font-semibold"
      >
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-end space-x-3 pt-4">
        ...
        <button
          onClick={() => onSave(form)}
          className="px-4 py-2 bg-brand-turquoise text-white rounded font-semibold"
        >
          Сохранить
        </button>
      </div>
