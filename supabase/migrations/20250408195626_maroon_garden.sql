/*
  ...
  1. Changes
    - Adds email field to user_profiles table
...
-- Update policies to handle email field
DO $$
BEGIN
  -- Update select policy to include email field
  ...
  -- Update update policy to allow email updates
